...
#define ANCHOR_ADDR         0x0001  /* Anchor short address */
#define TAG_ADDR            0x0000  /* Tag short address */
...
/**
 * @brief  Bật bộ đếm chu kỳ DWT (Cortex-M3) làm đồng hồ micro-giây.
 *         Gọi 1 lần sau SystemClock_Config().
 */
...
/**
 * @brief  Đọc mức logic chân IRQ (PA3) của DW1000.
